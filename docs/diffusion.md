...
Refer to @../src/ppx for the python implementation.  In particular,

- @../src/ppx/core/ocr.py describes the OCR service that powers the underlying layout analysis and OCR text extraction.
- @../src/ppx/core/types.py describes the data structures
- @../src/ppx/core/layout/layout_tree.py is the layout tree and related algorithms.
- @../src/ppx/core/algo.py is the collection of general purpose algorithms used.
