...
This is a svelte webapp that will use a server backend described in @api.md

This project will be purely client-side rendering.  All data fetching will be done with async api calls that return promises.

# shadcn-svelte

The project will only use shadcn-svelte framework for all its UI components.
